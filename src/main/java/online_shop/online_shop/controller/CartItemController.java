...
public class CartItemController {
    ...
    public ResponseEntity<List<CartItemDto>> getAllCartItemsByCartId(@PathVariable Long cartId) {
    ...
    public ResponseEntity<?> updateCartItem(@PathVariable Long cartId, @PathVariable Long itemId, @RequestBody CartItemDto cartItemDto) {
